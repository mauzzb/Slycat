...
export async function addToWishlist(gameId: number): Promise<any> {
    const r = await request('/zhelaemoe', { method: 'POST', body: String(gameId) });
    return r.json();
}

export async function removeFromWishlist(id: number): Promise<any> {
...
export async function addToCart(gameId: number): Promise<any> {
    const r = await request('/korzina', { method: 'POST', body: String(gameId) });
    return r.json();
}

export async function removeFromCart(id: number): Promise<any> {
